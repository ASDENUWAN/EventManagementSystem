...
<form method="POST" action="logcus" class="log_form" >
	<div class="log_form_text">
		<h2>CUSTOMER LOGIN</h2>
		<label for="name">Username</label><br>
		<input type="text" class="log_input" id="name" name="uname"  placeholder="abcd" required><br><br>
		<label for="psw">Password</label><br>
		<input type="password" id="pws" name="pwd" class="log_input" required><br><br>
